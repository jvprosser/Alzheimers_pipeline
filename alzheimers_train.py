...
first_snapshot=6922387089932845031
...
if __name__ == "__main__":
    ...
    # The predicted column is "diagnosis" which is a boolean (0,1)
    train_x = train.drop(["Diagnosis"], axis=1).drop(["DoctorInCharge"], axis=1).drop(["PatientID"], axis=1)
    test_x  = test.drop(["Diagnosis"], axis=1).drop(["DoctorInCharge"], axis=1).drop(["PatientID"], axis=1)
